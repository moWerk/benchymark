...
//
// SCALE: the SAME visual span as RERASTER, by the cheap route — a scale
// transform on base-size distance-field text. The RAG's recommended pattern.
...
Item {
    ...
    readonly property bool reraster: false
    property real k: 1
